...
import { ClipboardCheck, CheckCircle, Medal, Bell, CreditCard, MessageSquare, ArrowLeft, Check, UserPlus } from "lucide-react"
...
export default function TeacherNotificationsPage() {
    ...
    useEffect(() => {
        ...
        const channel = supabase
            .channel('teacher-notifications-page')
            .on(
                'postgres_changes',
                    ...
                    <div className="p-12 text-center">
                        ...
                        <p className="text-sm text-muted-foreground">
                            {filter === 'unread'
                                ...
                                : "We'll notify you about new students, messages, and updates"
                            }
                        </p>
                    </div>
                ) : (
